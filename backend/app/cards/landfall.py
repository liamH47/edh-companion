...
_SOURCES: dict[str, Source] = {
    ...
    "nissa-resurgent-animist": Source(
    ...
    "bristly-bill-spine-sower": Source(
...
def compute(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    # rather than once for the whole roster (build_lines handles that).
    per_ability = lands_this_turn * triggers_per_land

    effects, aggregate = build_lines(
        _SOURCES,
        sources,
        per_ability,
        ...
        rider_threshold=SECOND_RESOLUTION,
        forecast_note="on your next land",
    )
