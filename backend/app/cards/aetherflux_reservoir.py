...
from .schema import ActionGuard, CardMetadata, FieldKind, FieldSpec, OutputSpec, VisibleIf
...
METADATA = CardMetadata(
    ...
    outputs=[
        OutputSpec(name="life_this_spell", label="Life gained this spell"),
        OutputSpec(name="total_life", label="Total life gained"),
        OutputSpec(name="current_life", label="Current life total"),
        OutputSpec(name="damage_dealt", label="Damage dealt"),
        OutputSpec(name="possible_activations", label="Activations available"),
        OutputSpec(name="damage_available", label="Damage available"),
        OutputSpec(name="spells_until_next_activation", label="Spells until next activation"),
    ],
)
