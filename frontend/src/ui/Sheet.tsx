...
import { transitionDuration } from '../core/motion'
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div
        ...
        tabIndex={-1}
        className="relative flex w-full max-w-xl flex-col gap-4 rounded-t-lg border border-b-0 border-border bg-surface-raised p-4 outline-none"
